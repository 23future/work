        ...
        buildNavigation: function() { 
            ...
            if( panel ) {
                var nav = '<ul class="pagination pull-left" style="margin: 0px;">'+
                    '<li><a href="#" class="circuit_modal" data-toggle="modal" data-target="#CircuitModal"><span class="glyphicon glyphicon-eye-open"></span></a></li>' +
                    '<li><a href="#" class="add_post" data-toggle="modal" data-target="#CreateModal"><span class="glyphicon glyphicon-plus"></span></a></li></ul>' +
